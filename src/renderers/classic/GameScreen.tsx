import { playSound, stopSound as stopTap } from "@/src/state/sound/gameplaysound";
...
import { BushesFull, Cloud, Skyline, Soil } from "./components/CloudAndSoil";
import Hud from "./components/Hud";
import Pipe from "./components/Pipe";
import { GAME_CONFIG } from "@/src/core/config";
import { computeBirdTiltDeg, registerTap } from "@/src/core/bird";
import { detectWorldCollision } from "@/src/core/collision";
import { advancePipesMut, applyBirdPhysics, recyclePipes } from "@/src/core/physics";
import { createPipeSpawner, pipeMovement, tickPipeSpawner } from "@/src/core/pipes";
import useScore from "@/src/core/score";
